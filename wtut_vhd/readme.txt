...
This zip file contains the design files for the ISE 11 In-depth tutorial (VHDL design flow).
-----------------------------------------------------------------------

Installation instructions
--------------------------
Unzip the file into a directory with READ/Write permissions.
 
Documentation
-------------
Refer to the ISE 11 In-depth tutorial available at:
